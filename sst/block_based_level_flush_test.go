...
func TestSingleSSTFileFlush(t *testing.T) {
	...
	accepting(flush, []byte{0}, []byte{0}, false, t)
	accepting(flush, []byte{1}, []byte{1}, false, t)
...
func TestMultiSSTFileFlush(t *testing.T) {
	...
	accepting(flush, []byte{3}, []byte{3}, false, t)
	accepting(flush, []byte{4}, []byte{4}, false, t)
	accepting(flush, []byte{5}, []byte{5}, false, t)
	accepting(flush, []byte{6}, []byte{6}, false, t)
	accepting(flush, []byte{7}, []byte{7}, false, t)
