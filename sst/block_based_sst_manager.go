...
func (manager *BlockBasedSSTManager) Flush(tables []*memtable.Memtable) (SSTManager, error) {
	...
	mergedIter := common.NewMergedIterator(iters, true)
	return manager.flushIter(mergedIter)
}

func (manager *BlockBasedSSTManager) flushIter(iter common.Iterator) (SSTManager, error) {
